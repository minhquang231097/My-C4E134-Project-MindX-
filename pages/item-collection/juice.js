...
for (let i = 0; i < imgList.length; i++) {
    imgList[i].addEventListener('click', () => window.location.href = `../product/product-${i+13}.html`)
}

for (let i = 0; i < productList.length; i++) {
    productList[i].addEventListener('click', () => window.location.href = `../product/product-${i+13}.html`)
}
